        ...
        <div className="sidbar">
            <div className="sidbar__top">
              <img 
                 ...
                 alt="" 
               />
              <Avatar src={user.photoUrl} className="sidbar__avatar">
                 {user.email[0]}
              </Avatar>
              <h2>{user.displayName}</h2>
              <h4>{user.email}</h4>
            </div>
            <div className="sidbar__stats">
               <div className="sidbar__stat">
                  <p>Who viewd you</p>
                  <p className="sidbar__statNumber">1,222</p>
               </div>
               <div className="sidbar__stat">
                  <p>Views on post</p>
                  <p className="sidbar__statNumber">1,222</p>
            ...
            <div className="sidbar__bottom">
               <p>Recent</p>
               {recenItem('reactJs')}
               {recenItem('programming')}
               {recenItem('softwareenginering')}
               {recenItem('design')}
               {recenItem('developer')}
            </div>
        </div>
